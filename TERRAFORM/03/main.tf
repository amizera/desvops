resource "digitalocean_droplet" "main" {
  name   = "adam-mizera-github-actions-droplet"
  region = "fra1"
  size   = "s-1vcpu-1gb"
...
resource "digitalocean_project" "main" {
  name        = "adam-mizera-github-actions-project"
...
resource "digitalocean_vpc" "main" {
  name     = "adam-mizera-github-actions-vpc"
  region   = "fra1"
  ip_range = "10.123.10.0/24"
}
...
resource "digitalocean_ssh_key" "main" {
  name       = "adam-mizera-github-actions-ssh-key"
  public_key = tls_private_key.main.public_key_openssh
}

resource "digitalocean_ssh_key" "own" {
  name       = "adam-mizera-github-actions-own-ssh-key"
  public_key = var.own_ssh_public_key

}

resource "digitalocean_firewall" "main" {
  name        = "adam-mizera-github-actions-firewall"
